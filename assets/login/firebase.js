      ...
      const firebaseConfig = {
        ...
        apiKey: "AIzaSyDBT2fDQDVcL4tzINdeiH7vMpVFg7EcaAA",
        authDomain: "aviccomm.firebaseapp.com",
        projectId: "aviccomm",
        storageBucket: "aviccomm.appspot.com",
        messagingSenderId: "429173646317",
        appId: "1:429173646317:web:f64f0e568f39c4faccbde4",
        measurementId: "G-DN4XKGVE1P"
  };
          ...
          console.log("Download Clicked");
            ...
            itemRef.getDownloadURL().then(function(url) {
              ...
              // This can be downloaded directly:
                  ...
                  window.open(url);  
                  $("#file_name").val(url);
                  // window.location.assign(url);   // open the url in MAC Safari
                  setTimeout(function () {
                    window.open(url);
                  }, 1);
