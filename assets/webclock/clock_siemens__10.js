(function () {
    ...
    */
    ...
    if (month_now >4 && month_now <10){winter = 0;}
    else if (month_now == 4){
        if (ddt >= 1 && ddt <= 7){
            if(ddt < yy+1){ winter = 1;}
            else{
                if (yy==0){if (ddh<3){ winter = 1;}else{winter =0;} }
                else{winter = 0;}}}
        else{winter = 0;}}
    ...
    document.getElementById("time_Australia").innerHTML  = "(+" + (dt_hour + winter) + ")"; 
